...
def cakes(recipe, available):
    ...
    for ingredient in recipe:
        if ingredient not in available:
            ...
            arr.append(int(available[ingredient] / recipe[ingredient]))
    return(min(arr))

print(cakes({"flour": 500, "sugar": 200, "eggs": 1}, {"flour": 1200, "sugar": 1200, "eggs": 5, "milk": 200})) # should return 2
print(cakes({"apples": 3, "flour": 300, "sugar": 150, "milk": 100, "oil": 100}, {"sugar": 500, "flour": 2000, "milk": 2000})) # should return 0